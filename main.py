...
'''
Получение всех списков для сопостовления с ID
'''
def get_lists():
...
'''
Получение рассылочных компаний
'''
...
'''
Получение статистики по рассылочным компаниям.
'''
...
'''
Сохранение в XLSX документ используя Pandas.
Последовательность колонок можно настроить.
'''
...
if __name__ == '__main__':
    #Введите диапазон дат отправки YYYY-MM-DD hh:mm:ss
